...
function openSection(id){
  ...
  const theme = COURSE_THEME[s.course];
  document.getElementById('detailIconChip').style.background = theme.soft;
  document.getElementById('detailIconChip').style.color = theme.color;
  document.getElementById('detailIconChip').innerHTML = ICONS[s.course];
  document.getElementById('detailTitle').textContent = s.name;
  document.getElementById('detailSubtitle').textContent = s.teacher;
  document.getElementById('detailAvgXp').textContent = s.avgXp.toLocaleString('es-PE') + ' XP';
  document.getElementById('detailActivity').textContent = s.activity + '%';
  document.getElementById('detailCount').textContent = s.students;
...
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('sectionGrid')) {
